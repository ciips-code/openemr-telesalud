...
class InsuranceNumbers extends ORDataObject
{
        ...
        var $provider_number_type_array = array ("" => "Unspecified", "0B" => "Professional identification number", "1A" => "Blue Cross Provider Number","1B" => "Blue Shield Provider Number","1C" => "Medicare Provider Number",
        ...
        var $rendering_provider_number_type_array = array ("" => "Unspecified", "0B" => "Professional identification number", "1A" => "Blue Cross Provider Number","1B" => "Blue Shield Provider Number","1C" => "Medicare Provider Number",
