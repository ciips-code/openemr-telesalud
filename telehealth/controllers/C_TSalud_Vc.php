...
<li>Paciente: <a href=\"{$patient_url}\" target=\"_blank\" id=\"patientButton\">{$patient_url}</a> &nbsp  <a class=\"btn btn-primary\" href=\"#\" onclick=\"copyLinkToClipboard('patientButton', this);\">" . xlt('Copy patient link') . "</a></li>
</ul>
");
